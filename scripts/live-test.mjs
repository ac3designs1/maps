...
try {
  ...
  }
  {
    ...
    const guards = ["function backToList", "lockStart:isHereStop(S.trip.stops[0])", "Where to?", "readOnly", "is-hot", "function updateHereDot", "You're offline.", "function forgetLast", "isHereStop(stop) && !hit.here", "smoothFactor:0", "startTrafficWatch", "trafficDelayS", "maps.recentPlaces", "function runSuggest", "function cancelSuggest", "function matchLocalPlaces", "function queryTokens", "hit.searchQuery", "function typedQueryHit", "function duplicateTrip", "function setRecords", "function dwellMinutes", "sug-call", "data-more=\"paste\"", "data-more=\"here\"", "function confirmDeleteTrip", "trip-del-reveal", "function routeStops", "function cycleStopState", "function openLeaveModal", "hoursWeek", "window.Capacitor?.Plugins?.Geolocation", "function isNativeApp", "function nativeInit"];
  ...
  // IDs in HTML exist in JS
  {
    ...
    const js = (await req("/app.js?v=58")).text;
    ...
    const required = ["listScreen","tripScreen","sheet","stopList","btnStart","btnBack","btnNew","btnEmptyNew","modal","toast","suggestBox","summaryTap"];
